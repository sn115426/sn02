...
.setImage('https://tenor.com/view/poggers-anime-girls-kissing-pog-gif-18050577')
message.channel.send(embed);
}else if(command === 'suffix'){
client.commands.get('suffix').execute(message, args);
}else if (command === 'allah'){
message.channel.send('praise allah!')
...
const embed = new Discord.MessageEmbed()
.setDescription('do tha fatfuck')
.setImage('https://cdn.discordapp.com/attachments/452733553122476062/655291803087667201/image0.png')
message.channel.send(embed);
}
